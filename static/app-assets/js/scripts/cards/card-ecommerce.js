            ...
            ************************************/
            ...
            var topCategoryChartOptions = {
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['Operational', 'Idle', 'Under Repair', 'For Disposal'],
                    textStyle: {
                        color: '#FFF'
                    },
                },
                ...
                // Add custom colors
                color: ['#ffd322', '#ffa422', '#e89805', '#ffc107'],
                ...
                series: [
                    {
                        ...
                        data: [
                            {value: {{ total_operational }}, name: 'Operational'},
                            {value: {{ total_idle }}, name: 'Idle'},
                            {value: {{ total_repair }}, name: 'Under Repair'},
                            {value: {{ total_disposal }}, name: 'For Disposal'},
                        ]
                    }
                ]
            };
